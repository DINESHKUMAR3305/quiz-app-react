    ...
    const Quiz = () => {
      ...
      return (
        <div className="App">
          ...
          {!quizCompleted ? (
            <>
              <div className="quiz-container">{displayPage()}</div>
              <div className="navigation-buttons">
                ...
                <button
                  onClick={nextPage}
                  disabled={currentPage === Math.ceil(shuffledQuestions.length / 5) - 1}
                >
                  Next
                </button>
              </div>
              {currentPage === Math.ceil(shuffledQuestions.length / 5) - 1 && (
